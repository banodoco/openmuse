...
import { Eye, Trash, VideoIcon, Check, X } from 'lucide-react';
              ...
              {selectedVideo ? (
                <>
                  <div className="bg-card rounded-lg shadow-sm p-4 border">
                    <h3 className="text-lg font-semibold mb-3">Original Video</h3>
                    <div className="aspect-video w-full bg-black rounded-md overflow-hidden">
                      <VideoPlayer src={selectedVideo} controls autoPlay={false} muted={false} />
                    </div>
                  </div>
                  ...
                  {selectedResponse ? (
                    <div className="bg-card rounded-lg shadow-sm p-4 border">
                      ...
                      <div className="aspect-video w-full bg-black rounded-md overflow-hidden">
                        <VideoPlayer src={selectedResponse} controls autoPlay={false} muted={false} />
                      </div>
                    </div>
                  ) : (
